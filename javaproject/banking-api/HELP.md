...
* The original package name 'net-banking-api.banking-api' is invalid and this project uses 'net_banking_api.banking_api' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/data/sql.html#data.sql.jdbc)
